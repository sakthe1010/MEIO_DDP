...
|----------------|-------:|------:|
| **Total cost** | **272,972** | 100% |
| Holding | 84,111 | 30.8% |
| Transport | 138,738 | 50.8% |
...
- Baseline total cost is **272,972**, dominated by transport (50.8%) — this is the primary optimisation target for subsequent experiments.
