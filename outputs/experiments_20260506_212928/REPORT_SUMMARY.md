...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 473,470 | -13.6% |
| Fill rate | 97.73% | +6.14 pp |
| Transport share | 70.0% | -9.5 pp |
| Holding share | 20.4% | +15.3 pp |
...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 261,248 | +37.3% |
| Fill rate | 98.72% | +7.13 pp |
| Transport share | 52.7% | -26.8 pp |
| Holding share | 31.1% | +26.1 pp |
| Shortage share | 1.3% | -4.8 pp |

**Key findings:**

- **37.3% total cost reduction** vs E0 baseline (from 416,952 to 261,248).
- Fill rate improved by **7.13 percentage points** over baseline.
- Transport cost share decreased by **26.8 pp** (from 79.5% to 52.7%), reflecting effective vehicle consolidation.
...
- Total cost is **433.0% higher** than E0 baseline — this experiment trades cost for service quality.
...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 352,015 | +15.6% |
| Fill rate | 94.33% | +2.75 pp |
| Transport share | 60.5% | -19.0 pp |
| Holding share | 32.7% | +27.7 pp |
| Shortage share | 4.3% | -1.8 pp |

**Key findings:**

- **15.6% total cost reduction** vs E0 baseline (from 416,952 to 352,015).
- Fill rate improved by **2.75 percentage points** over baseline.
- Transport cost share decreased by **19.0 pp** (from 79.5% to 60.5%), reflecting effective vehicle consolidation.
- Holding cost share is **27.7 pp higher** (32.7% vs 5.0% in E0), reflecting elevated base-stock levels to enable consolidation.
...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 409,051 | +1.9% |
| Fill rate | 88.48% | -3.11 pp |
| Transport share | 53.7% | -25.9 pp |
| Holding share | 24.5% | +19.4 pp |
| Shortage share | 19.4% | +13.2 pp |

**Key findings:**

- **1.9% total cost reduction** vs E0 baseline (from 416,952 to 409,051).
- Fill rate **dropped 3.11 pp** vs baseline (88.48%). Below 92% target — the consolidation constraint is harming service.
- Transport cost share decreased by **25.9 pp** (from 79.5% to 53.7%), reflecting effective vehicle consolidation.
- Holding cost share is **19.4 pp higher** (24.5% vs 5.0% in E0), reflecting elevated base-stock levels to enable consolidation.
- Shortage cost share **increased by 13.2 pp** (19.4% vs 6.1% in E0).
...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 486,394 | -16.7% |
| Fill rate | 98.46% | +6.87 pp |
| Transport share | 68.3% | -11.2 pp |
| Holding share | 23.5% | +18.5 pp |
| Shortage share | 0.9% | -5.2 pp |

**Key findings:**

- Total cost is **16.7% higher** than E0 baseline — this experiment trades cost for service quality.
- Fill rate improved by **6.87 percentage points** over baseline.
- Transport cost share decreased by **11.2 pp** (from 79.5% to 68.3%), reflecting effective vehicle consolidation.
- Holding cost share is **18.5 pp higher** (23.5% vs 5.0% in E0), reflecting elevated base-stock levels to enable consolidation.
- Shortage cost share **reduced by 5.2 pp** (0.9% vs 6.1% in E0).
...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 262,077 | +37.1% |
| Fill rate | 98.65% | +7.06 pp |
| Transport share | 52.7% | -26.8 pp |
| Holding share | 31.1% | +26.0 pp |
| Shortage share | 1.4% | -4.7 pp |

**Key findings:**

- **37.1% total cost reduction** vs E0 baseline (from 416,952 to 262,077).
- Fill rate improved by **7.06 percentage points** over baseline.
- Transport cost share decreased by **26.8 pp** (from 79.5% to 52.7%), reflecting effective vehicle consolidation.
- Holding cost share is **26.0 pp higher** (31.1% vs 5.0% in E0), reflecting elevated base-stock levels to enable consolidation.
- Shortage cost share **reduced by 4.7 pp** (1.4% vs 6.1% in E0).
...
- **36.3% total cost reduction** vs E0 baseline (from 416,952 to 265,798).
...
- **34.5% total cost reduction** vs E0 baseline (from 416,952 to 272,972).
...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 283,098 | +32.1% |
| Fill rate | 93.10% | +1.51 pp |
| Transport share | 49.5% | -30.1 pp |
| Holding share | 28.9% | +23.9 pp |
| Shortage share | 7.9% | +1.8 pp |

**Key findings:**

- **32.1% total cost reduction** vs E0 baseline (from 416,952 to 283,098).
- Fill rate improved by **1.51 percentage points** over baseline.
- Transport cost share decreased by **30.1 pp** (from 79.5% to 49.5%), reflecting effective vehicle consolidation.
...
| KPI | Value | vs E0 |
|-----|------:|------:|
| Total cost | 260,690 | +37.5% |
| Fill rate | 96.83% | +5.24 pp |
| Transport share | 52.5% | -27.0 pp |
| Holding share | 29.6% | +24.6 pp |
| Shortage share | 2.9% | -3.2 pp |

**Key findings:**

- **37.5% total cost reduction** vs E0 baseline (from 416,952 to 260,690).
- Fill rate improved by **5.24 percentage points** over baseline.
- Transport cost share decreased by **27.0 pp** (from 79.5% to 52.5%), reflecting effective vehicle consolidation.
- Holding cost share is **24.6 pp higher** (29.6% vs 5.0% in E0), reflecting elevated base-stock levels to enable consolidation.
- Shortage cost share **reduced by 3.2 pp** (2.9% vs 6.1% in E0).
...
E2         | E2 — Inventory-Only Opt (≥92%)         | 473,470    | -13.6%  | 20.4      | 70.0        | 8.2        | 1.4        | 97.73      
E3         | E3 — Joint Opt (≥92%)                  | 261,248    | +37.3%  | 31.1      | 52.7        | 14.9       | 1.3        | 98.72      
...
E5         | E5 — E3 under W1 outage                | 2,222,406  | -433.0% | 10.3      | 6.4         | 1.5        | 81.8       | 81.86      
E6         | E6 — base_stock                        | 458,021    | -9.8%   | 16.8      | 72.4        | 8.5        | 2.3        | 96.29      
E6         | E6 — ss                                | 352,015    | +15.6%  | 32.7      | 60.5        | 2.5        | 4.3        | 94.33      
E6         | E6 — periodic_review                   | 409,051    | +1.9%   | 24.5      | 53.7        | 2.5        | 19.4       | 88.48      
E6         | E6 — echelon_stock                     | 486,394    | -16.7%  | 23.5      | 68.3        | 7.2        | 0.9        | 98.46      
E7         | E7 — σ_f = 0%                          | 262,077    | +37.1%  | 31.1      | 52.7        | 14.8       | 1.4        | 98.65      
E7         | E7 — σ_f = 5%                          | 265,798    | +36.3%  | 31.2      | 51.9        | 14.6       | 2.2        | 98.08      
E7         | E7 — σ_f = 10%                         | 272,972    | +34.5%  | 30.8      | 50.8        | 14.2       | 4.1        | 96.71      
...
E8         | E8 — λ=1e+04                           | 283,098    | +32.1%  | 28.9      | 49.5        | 13.7       | 7.9        | 93.10      
E8         | E8 — λ=1e+05                           | 260,690    | +37.5%  | 29.6      | 52.5        | 14.9       | 2.9        | 96.83      
...
----------------+-------------------+------------+-----------------+-----------
92.0            | 96.38             | 288701.3   | 18.0            | 27.0      
93.0            | 97.2              | 316062.09  | 10.0            | 46.0      
94.0            | 96.51             | 316561.82  | 11.0            | 12.0      
95.0            | 96.12             | 342736.55  | 11.0            | 28.0      
96.0            | 98.69             | 304098.39  | 10.0            | 40.0      
97.0            | 96.23             | 350164.05  | 0.0             | 39.0      
98.0            | 98.6              | 304663.63  | 4.0             | 41.0      
99.0            | 98.93             | 355758.43  | 0.0             | 46.0      
...
1. **Joint optimization (E3) achieves a 37.3% total cost reduction** over the analytical baseline while meeting the 92% fill rate target (achieved: 98.72%). This is the primary result of the dissertation.

2. **Inventory-only optimization (E2) increases cost by 13.6%**, confirming that optimizing inventory alone is insufficient compared to joint optimization.
