...
|----------------|-------:|------:|
| **Total cost** | **283,098** | 100% |
| Holding | 81,785 | 28.9% |
| Transport | 140,031 | 49.5% |
...
- Baseline total cost is **283,098**, dominated by transport (49.5%) — this is the primary optimisation target for subsequent experiments.
