...
|----------------|-------:|------:|
| **Total cost** | **262,077** | 100% |
| Holding | 81,407 | 31.1% |
| Transport | 138,149 | 52.7% |
...
- Baseline total cost is **262,077**, dominated by transport (52.7%) — this is the primary optimisation target for subsequent experiments.
