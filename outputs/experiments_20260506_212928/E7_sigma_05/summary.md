...
|----------------|-------:|------:|
| **Total cost** | **265,798** | 100% |
| Holding | 82,955 | 31.2% |
| Transport | 138,049 | 51.9% |
...
- Baseline total cost is **265,798**, dominated by transport (51.9%) — this is the primary optimisation target for subsequent experiments.
