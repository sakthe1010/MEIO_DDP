...
|----------------|-------:|------:|
| **Total cost** | **2,222,406** | 100% |
| Holding | 229,746 | 10.3% |
| Transport | 143,267 | 6.4% |
| Ordering | 32,438 | 1.5% |
...
- Baseline total cost is **2,222,406**, dominated by transport (6.4%) — this is the primary optimisation target for subsequent experiments.
