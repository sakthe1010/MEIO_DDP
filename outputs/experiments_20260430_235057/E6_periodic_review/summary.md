...
|----------------|-------:|------:|
| **Total cost** | **407,719** | 100% |
| Holding | 100,076 | 24.5% |
| Transport | 218,127 | 53.5% |
| Ordering | 10,330 | 2.5% |
...
- Baseline total cost is **407,719**, dominated by transport (53.5%) — this is the primary optimisation target for subsequent experiments.
