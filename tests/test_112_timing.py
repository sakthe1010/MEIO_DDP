...
def test_112_first_receipts():
    cfg = {
        ...
        "nodes": [
            ...
            },
            {
                "id": "WH",
                "type": "warehouse",
                "initial_inventory": {"SKU1": 40},
                "policy": {"SKU1": {"type": "base_stock", "base_stock_level": 60}},
            },
            {
                "id": "R1",
                "type": "retailer",
                "initial_inventory": {"SKU1": 10},
                "policy": {"SKU1": {"type": "base_stock", "base_stock_level": 20}},
            },
            {
                "id": "R2",
                "type": "retailer",
        ...
        "demand": [
            {"node": "R1", "sku": "SKU1", "generator": {"type": "deterministic", "value": 3}},
            {"node": "R2", "sku": "SKU1", "generator": {"type": "deterministic", "value": 2}},
        ],
    }
    ...
    # Filter to SKU1 (single SKU case)
    df = df[df["sku"] == "SKU1"]
